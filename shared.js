...
<nav id="main-nav">
  ...
  <a href="https://pos.khairitsolution.com" target="_blank" class="nav-cta" style="background:var(--bg); border:1px solid var(--border); color:var(--text); margin-right:12px;">Open POS →</a>
...
<div class="mobile-menu" id="mobile-menu">
  ...
  <a href="https://pos.khairitsolution.com" target="_blank" style="color:var(--accent);">Open POS →</a>
</div>`;
